...
**Last Updated:** 2026-04-29 (capture_helper tooling DONE; Phase 8.5 selectors next)
...
| Shot Controls | 🔶 **Phase 7 COMPLETE (83/83 tests)**. **Phase 8 Shot UI Polish IN PROGRESS** — Parts 8.1 + 8.2 + 8.2.5 + 8.3 + 8.4 + **8.5 COMPLETE**. 2×2 SPIN/FADE-DRAW/GOLFIN/DRIVER cluster, SpinPanel, ball/club selector (8.5.C), CentralBallWidget + targeting line + handle start position (8.5.D) all done. **Next:** Phase 8.6 TBD. |
