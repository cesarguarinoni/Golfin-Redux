...
**Last Updated:** 2026-05-04 18:14 JST (Architect prep for tomorrow done. Notion C entry updated; two new entries created (`controls_c_fix` P0 Order 125 + `controls_d_velocity_cap_diagnosis` P2 Order 145). Architect notes file at `Docs/Specs/Queued/controls_c_fix/NOTES.md` with code refs walked today, three-concern breakdown, three repair-option candidates for stop-check clause 2, and three open questions for Cesar before SPEC.md writing kicks off. TellCode.md flipped diagnosis + hole_selection_screen to ✅ DONE.)
