...
- **NEXT / open:** next pick pending Cesar — candidates: `water_splash_fx` (349, P2), `sound_effects` (350, P2), `map_view_aiming` (352, P2), or the physics audit follow-ups. `tree_aware_bot` (351) is now unblocked but P3 — do not spec unprompted.
...
- **Last updated:** 2026-06-12 (Architect — tree_collisions (348) shipped + closed: Completed/ move, Notion Done, Lesson AA verified (core sim files in `2fb4c2b7`). Awaiting next pick.)
