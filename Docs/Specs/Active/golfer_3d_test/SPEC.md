...
| 9.7 | Housekeeping | The tree carries uncommitted control-scheme edits from another session — do **not** sweep them. `.git/objects/maintenance.lock` was left by an Architect fetch (the bridge cannot delete); remove it first. |
