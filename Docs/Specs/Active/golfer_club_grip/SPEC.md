...
|---|---|---|---|
| **0 — fist test** | Edit mode, rest pose, no club, no rig. `HandHingeModel` applies 65/85/40 to all four fingers, thumb flexed 30/20, both hands. | Both hands, palm side and back side, full res | Looks like a fist. Measured: tips 8–20 mm from the palm plane, adjacent tips ≥ 8 mm apart, no finger crosses another. EditMode tests green. **If this fails, stop — the axes are wrong.** |
