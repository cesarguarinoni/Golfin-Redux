...
import { buildLoanFunnel, buildLoanLifecycle, type LoanEventRow } from "../telemetryLoans";
import { isLoanLive, isLoanPending, loanAnchorMs, type LoanRow } from "../loanStatus";
