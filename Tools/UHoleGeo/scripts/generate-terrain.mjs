...
async function generateTerrainDEM(courseId, holeNumber, holeBounds, zonesData, config) {
  ...
  // Ravine carving removed — the DEM already preserves real ravines at
  // the correct depth now that MAX_PLAYABLE_RANGE is 50m and the adaptive
  // sigma doesn't over-smooth them away.
